...
class Users(commands.Cog):
    ...
    async def about(self, ctx):
        ...
        embed.add_field(
            name="OS", value="Ubuntu" if sys.platform == "linux" else "Windows"
        )
        ...
        embed.add_field(
            name="Source", value=f"[github]({self.bot.properties.github_url})"
        )
        embed.add_field(
            name="Add me!", value=f"[invite]({self.bot.properties.bot_url})"
        )
        embed.add_field(
    ...
    async def vote(self, ctx):
        lists = (
            "Please consider voting if you like our bot!\n"
